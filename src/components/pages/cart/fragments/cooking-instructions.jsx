...
export function CookingInstructions({ instructions, setInstructions }) {
        ...
        <div className="rounded-2xl bg-white dark:bg-zinc-900 p-4 border border-gray-150/70 dark:border-zinc-800 shadow-xs">
            ...
            >
                <div className="flex items-center gap-2.5">
                    <div className="flex size-8 items-center justify-center rounded-xl bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400">
            ...
            {isOpen && (
                <div className="mt-3.5 space-y-3 pt-3 border-t border-gray-100 dark:border-zinc-800 animate-in fade-in duration-200">
                    {/* Preset tags */}
                        ...
                        {presets.map((preset) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-semibold transition-all select-none cursor-pointer border ${
                                        isSelected
                    ...
                    <textarea
                        ...
                        placeholder="Write special requests (e.g. deliver at gate, ring doorbell twice)..."
                        maxLength={200}
                        rows={2}
                        className="w-full rounded-xl bg-neutral-50 dark:bg-zinc-850 p-3 text-xs sm:text-sm text-neutral-900 dark:text-zinc-100 placeholder:text-neutral-400 border border-gray-150/70 dark:border-zinc-750 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none"
                    />
                </div>
            )}
        </div>

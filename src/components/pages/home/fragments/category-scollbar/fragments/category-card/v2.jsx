...
const CategoryCardV2 = ({ category }) => {
    return (
        ...
        >
            <div className="relative flex aspect-square w-full items-center justify-center rounded-2xl bg-gradient-to-tr from-border/50 to-border/20 p-[2px] transition-all duration-300 ease-out group-hover:scale-105 group-hover:from-primary/80 group-hover:to-primary/30 group-hover:shadow-lg group-hover:shadow-primary/20 group-active:scale-95">
                <div className="relative h-full w-full overflow-hidden rounded-[14px] border-[2.5px] border-background bg-muted">
                    <ItemImage
                        src={category?.image}

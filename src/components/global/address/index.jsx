...
export function AddressManager({ onSelectAddress, selectedAddressId, readOnly = false }) {
    ...
    const addMutation = useMutation({
        mutationFn: (newAddress) => UserService.addAddress(slug, null, newAddress),
        onSuccess: () => {
    ...
    const updateMutation = useMutation({
        mutationFn: ({ addressId, data }) => UserService.updateAddress(slug, null, addressId, data),
        onSuccess: () => {
            queryClient.invalidateQueries(["user-addresses", slug, userId]);
    ...
    const deleteMutation = useMutation({
        mutationFn: (addressId) => UserService.deleteAddress(slug, null, addressId),
        onSuccess: () => {
            queryClient.invalidateQueries(["user-addresses", slug, userId]);

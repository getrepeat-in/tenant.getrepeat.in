...
export function ItemImage({ src, alt = "Item Image", className, variant = "card", loading = "lazy" }) {
            ...
            {showPlaceholder ? (
                <div className="relative flex flex-col items-center justify-center w-full h-full bg-neutral-100/90 dark:bg-zinc-800/90 overflow-hidden">
                    {formattedLogoUrl ? (
                        ...
                        <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-neutral-100 to-neutral-200/40 dark:from-zinc-800 dark:to-zinc-900/60">
                            <div className="p-3 bg-white/60 dark:bg-zinc-800/80 rounded-2xl shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-white/50 dark:border-zinc-700/50 backdrop-blur-sm">
                                <Utensils className="w-6 h-6 text-neutral-400/70 dark:text-neutral-500/70" strokeWidth={1.5} />
                            </div>
                        </div>
                    )}
                </div>

                    ...
                    <div className="space-y-2">
                        <div className="relative group">
                            <div className="absolute -top-2.5 left-3 z-10 bg-white px-1.5 sm:bg-white">
                                <span className={`text-[11px] font-semibold uppercase tracking-wider transition-colors ${formik.touched.name && formik.errors.name ? "text-red-500" : "text-slate-500 group-focus-within:text-orange-600"}`}>
                                    Full Name
                                </span>
                            </div>
                            <div className={`relative flex items-center rounded-2xl border bg-white transition-all sm:bg-white/90 ${formik.touched.name && formik.errors.name ? "border-red-500 focus-within:ring-1 focus-within:ring-red-500" : "border-gray-300 focus-within:border-orange-500 focus-within:ring-1 focus-within:ring-orange-500"}`}>
                                <div className="pointer-events-none flex items-center pl-3.5">
                                    <UserIcon className={`h-5 w-5 ${formik.touched.name && formik.errors.name ? "text-red-500" : "text-orange-500"}`} />
                                </div>
                                <input
                                    id="name"
                                    name="name"
